 ...
 *
 * Reads the configuration file at ~/.nekofree/plugins/known_marketplaces.json
 ...
 *
 * Writes the configuration to ~/.nekofree/plugins/known_marketplaces.json,
 ...
 * The configuration is saved to ~/.nekofree/plugins/known_marketplaces.json.
 *
